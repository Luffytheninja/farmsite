                ...
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                    ...
                    <div className="w-full lg:w-1/2 relative">
                        <div className="relative h-[500px] w-full rounded-3xl overflow-hidden shadow-2xl">
                            ...
                            />
                            {/* Floating Card */}
                            <div className="absolute bottom-8 left-8 bg-white/90 backdrop-blur-sm p-6 rounded-xl shadow-lg border border-accent/20">
                                <p className="text-4xl font-bold text-accent">25+</p>
                                <p className="text-primary font-medium">Years of Experience</p>
                            </div>
                        </div>
                        {/* Decorative background element */}
                        <div className="absolute -z-10 top-10 -left-10 w-full h-full bg-cream rounded-3xl" />
                    </div>
