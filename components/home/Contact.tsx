            ...
            <div className="container-max container-padding">
                <div className="flex flex-col lg:flex-row gap-12 bg-white rounded-3xl overflow-hidden shadow-xl">
                    ...
                    <div className="w-full lg:w-5/12 relative min-h-[500px] lg:min-h-full">
                        ...
                        />
                        <div className="absolute inset-0 bg-primary/90 p-8 md:p-12 flex flex-col justify-between">
                            <div>
                        ...
                        <form className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-3 rounded-lg bg-cream/30 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-accent/20 focus:border-accent transition-all"
                                    />
                                </div>
                                <div className="space-y-2">
                                    <label htmlFor="email" className="text-sm font-medium text-primary">Your Email</label>
                                    <input
                                        id="email"
                                        type="email"
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea
                                    ...
                                    className="w-full px-4 py-3 rounded-lg bg-cream/30 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-accent/20 focus:border-accent transition-all resize-none"
                                />
                            </div>

                            <Button size="lg" className="w-full bg-accent hover:bg-accent/90 text-white font-bold h-12 rounded-lg">
                                Send Message
                            </Button>
                        </form>
                    </div>
