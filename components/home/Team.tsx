            ...
            <div className="container-max container-padding">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    {team.map((member, index) => (
                        <div key={index} className="group relative rounded-2xl overflow-hidden bg-cream/30 hover:bg-white hover:shadow-xl transition-all duration-300">
                            <div className="relative h-[350px] w-full overflow-hidden">
                                ...
                                <div className="absolute bottom-4 right-4 flex flex-col gap-2 items-end">
                                    <div className="bg-accent text-white p-3 rounded-full shadow-lg z-10 relative">
                                    ...
                                    <div className="flex flex-col gap-2 translate-y-20 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300">
                                        {[Facebook, Twitter, Instagram, Linkedin].map((Icon, i) => (
                                            <a
                                                key={i}
                                                href="#"
                                                className="bg-white text-primary hover:bg-primary hover:text-white p-2.5 rounded-full shadow-md transition-colors"
                            ...
                            <div className="p-6 text-center group-hover:text-left transition-all duration-300">
                                <h3 className="text-xl font-bold text-primary font-serif mb-1 group-hover:text-accent transition-colors">
                                    {member.name}
                                </h3>
